...
class MySQLHelper
{
     ...
     * @param string $scoreAggregator must be a valid SQL expression returning a scalar number
     * @param string $groupMetadataSelector must be a JSON aggregate function call
     * @return string
     */
